function [presence, O_b, O_d] = createFibroPatternNoFibresModified(mesh, density, params, Ps, offsets)
...
% Create a new permutation table for the final noise field
% O_d2 = Octave2D(mesh.points' / patch_size, 3, 0.5, Ps3, offsets);
% disp('O_d2 done');
